...
var dialects = {
  pg     : require('sql/lib/dialect/postgres'),
  sqlite : require('sql/lib/dialect/sqlite'),
  mysql  : require('sql/lib/dialect/mysql'),
  mssql  : require('sql/lib/dialect/mssql'),
  oracle  : require('sql/lib/dialect/oracle')
};
