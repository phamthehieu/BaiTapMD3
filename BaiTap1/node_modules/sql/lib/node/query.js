...
var alias = require('sql/lib/node/alias');
var assert = require('assert');
var sliced = require('sliced');
var util   = require('util');
var valueExpressionMixin = require('sql/lib/node/valueExpression');

var Node            = require('sql/lib/node');
var Select          = require('sql/lib/node/select');
var From            = require('sql/lib/node/from');
var Where           = require('sql/lib/node/where');
var OrderBy         = require('sql/lib/node/orderBy');
var GroupBy         = require('sql/lib/node/groupBy');
var Having          = require('sql/lib/node/having');
var Insert          = require('sql/lib/node/insert');
var Replace         = require('sql/lib/node/replace');
var Update          = require('sql/lib/node/update');
var Delete          = require('sql/lib/node/delete');
var Returning       = require('sql/lib/node/returning');
var OnDuplicate     = require('sql/lib/node/onDuplicate');
var OnConflict      = require('sql/lib/node/onConflict');
var ForUpdate       = require('sql/lib/node/forUpdate');
var ForShare        = require('sql/lib/node/forShare');
var Create          = require('sql/lib/node/create');
var Drop            = require('sql/lib/node/drop');
var Truncate        = require('sql/lib/node/truncate');
var Distinct        = require('sql/lib/node/distinct');
var DistinctOn      = require('sql/lib/node/distinctOn');
var Alter           = require('sql/lib/node/alter');
var AddColumn       = require('sql/lib/node/addColumn');
var DropColumn      = require('sql/lib/node/dropColumn');
var RenameColumn    = require('sql/lib/node/renameColumn');
var Rename          = require('sql/lib/node/rename');
var Column          = require('sql/lib/column');
var ParameterNode   = require('sql/lib/node/parameter');
var PrefixUnaryNode = require('sql/lib/node/prefixUnary');
var IfExists        = require('sql/lib/node/ifExists');
var IfNotExists     = require('sql/lib/node/ifNotExists');
var OrIgnore        = require('sql/lib/node/orIgnore');
var Cascade         = require('sql/lib/node/cascade');
var Restrict        = require('sql/lib/node/restrict');
var Indexes         = require('sql/lib/node/indexes');
var CreateIndex     = require('sql/lib/node/createIndex');
var DropIndex       = require('sql/lib/node/dropIndex');
var Table           = require('sql/lib/node/table');
var CreateView     = require('sql/lib/node/createView');
var JoinNode        = require('sql/lib/node/join');
...
var Query = Node.define({
  ...
  delete: function(params) {
    var result;
    if (params) {
      var TableDefinition = require('sql/lib/table');
