...
var OrderByValueNode = require('sql/lib/node/orderByValue');
var ParameterNode    = require('sql/lib/node/parameter');
var TextNode         = require('sql/lib/node/text');
...
var ValueExpressionMixin = function() {
  var BinaryNode       = require('sql/lib/node/binary');
  var InNode           = require('sql/lib/node/in');
  var NotInNode        = require('sql/lib/node/notIn');
  var CastNode         = require('sql/lib/node/cast');
  var PostfixUnaryNode = require('sql/lib/node/postfixUnary');
  var TernaryNode      = require('sql/lib/node/ternary');
  var CaseNode         = require('sql/lib/node/case');
  var AtNode           = require('sql/lib/node/at');
  var SliceNode        = require('sql/lib/node/slice');
